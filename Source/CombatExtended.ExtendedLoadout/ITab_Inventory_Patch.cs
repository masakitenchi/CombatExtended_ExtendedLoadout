...
//Prior to 1.3 the method is in ITab_Inventory.FillTab(). Since Multiplayer Support the SetLoadout get moved to a separate method, ITab_Inventory.SyncedAddLoadout(Pawn p).
...
public static class ITab_Inventory_Patch
{
	...
	public static IEnumerable<CodeInstruction> SyncedAddLoadout_Transpiler(IEnumerable<CodeInstruction> instructions)
	{
		...
		Log.Error("Outdated transpiler ITab_Inventory.SyncedAddLoadout");
		return instructions;
	}
}
